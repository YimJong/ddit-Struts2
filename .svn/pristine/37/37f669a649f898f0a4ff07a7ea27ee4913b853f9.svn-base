package kr.or.ddit.user.sumnail.service;
...
import kr.or.ddit.user.sumnail.dao.FreeboardDAOImpl;
import kr.or.ddit.user.sumnail.dao.IFreeboardDAO;
...
public class FreeboardServiceImpl implements IFreeboardService {
	...
	@Override
	public String searchFile(String board_no) {
		String save_file_name = null;
		try {
			save_file_name = freeboardDAO.searchFile(board_no);
		} catch (Exception e) {
			e.printStackTrace();
		}
