...
<div id="freeboardList_content">
   <div class="panel panel-blue">
       <div class="panel-heading">썸네일 목록</div>
      <table class="table table-bordered table-hover">
         <thead>
            <tr>
               <th scope="col" width="5%">No</th>
               <th scope="col" width="45%">사진</th>
		   ...
		   <c:if test="${!empty freeboardList }">
				<c:forEach items="${freeboardList }" var="freeboardInfo">
					<tr>
						...
						<td>${freeboardInfo.board_title }</td>
						<td>${freeboardInfo.board_writer }</td>
...
<div >
<form action="${pageContext.request.contextPath }/user/sumnail/sumnailList.do" method="post" class="form-inline pull-right">
...
<script type="text/javascript">
	$(function(){
		$('#freeboardTBY tr').click(function(){
				...
				var url='${pageContext.request.contextPath }/user/sumnail/sumnailView.do';
		...
		$('#registBTN').click(function(){
				$(location).attr('href','${pageContext.request.contextPath }/user/sumnail/sumnailForm.do');
		});
