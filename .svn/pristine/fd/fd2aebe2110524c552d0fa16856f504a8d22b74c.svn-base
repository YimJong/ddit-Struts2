...
$(function(){
    ...
    $('#freeboardForm').submit(function(){
	    ...
	    $(this).attr('action','${pageContext.request.contextPath }/file/sumnailfileAdminUpload.do');
    ...
    $('#listBtn').click(function(){
    	location.href='${pageContext.request.contextPath}/admin/sumnail/sumnailList.do';
    });
...
<body>
<form id="freeboardForm" class="form-horizontal" role="form" action="${pageContext.request.contextPath }/file/sumnailfileAdminUpload.do" method="post" enctype="multipart/form-data">
