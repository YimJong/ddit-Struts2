...
<script type="text/javascript">
	$(function(){
		...
		$('#noticeboardTBY tr').click(function(){
			...
			$(location).attr('href', '${pageContext.request.contextPath }/admin/referenceRoom/referenceRoomView.do?board_no=' + board_no + '&rnum=' + rnum + '&search_keyword=' + search_keyword + '&search_keycode=' + search_keycode + '&currentPage=' + currentPage);
		});
