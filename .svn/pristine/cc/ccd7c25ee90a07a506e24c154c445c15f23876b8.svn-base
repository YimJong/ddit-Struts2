...
import java.security.KeyPair; //생성된 공개키 비밀키 받는 자원
import java.security.KeyPairGenerator; //공개키 비밀키 생성하는 자원
...
public class CryptoGenerator {
   ...
   public static Map<String, String> generatePairKey(HttpSession session){
      ...
      try{
         ...
         //                        짝수 설정
         keyGenerator.initialize(2048); //반드시 짝수여야함
         //생성된 공개키, 비밀키 취득
         ...
         // double(64bit 배정도 소수 ) : 부호비트 1bit(양수 0 | 음수 1) + 지수 11bit(소수점 자릿수) + 가수 52bit(실수 표현)
