						...
						<table border="0" cellspacing="1" cellpadding="1">
							...
							<tr>
								...
								<td>
									...
									<input name="search_gugun" type="text" id="search_gugun" size="20" />
								</td>
							</tr>
							<tr>
								<th>연락처</th>
...
<script>
	$(document).ready(function() {
		...
		$('#searchBtn').on('click', function() {
			...
			let mem_add2 = "";
			if($('input[name=search_gugun]').val() == null) {
				mem_add2 = "";
			} else {
				mem_add2 = $('input[name=search_gugun]').val();
			}
			...
			let search_hp1 = "";
			if($('select[name=search_hp1]').val() == null) {
				search_hp1 = "";
			} else {
				search_hp1 = $('select[name=search_hp1]').val();
			}
			...
			let search_year = "";
			if($('select[name=search_year]').val() == null) {
				search_year = "";
			} else {
				search_year = $('select[name=search_year]').val();
			}
			
			let search_month = "";
			if($('select[name=search_month]').val() == null) {
				search_month = "";
			} else {
				search_month = $('select[name=search_month]').val();
			}
			
			let search_day = "";
			if($('select[name=search_day]').val() == null) {
				search_day = "";
			} else {
				search_day = $('select[name=search_day]').val();
			}
