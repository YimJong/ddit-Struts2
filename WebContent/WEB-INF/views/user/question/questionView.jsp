...
$(function(){
	...
	$('#freeboard').submit(function(){
    	...
    	if('${LOGIN_MEMBERINFO.mem_id}'==('${questionInfo.board_writer}')){
    		...
    		$(this).append('<input type="hidden" name="board_no" value="${questionInfo.board_no}"></input>');
    	}else{
    		alert('등록자만 수정가능합니다.');
    	}
		...
		$('#listBtn').click(function(){
	    	location.href='${pageContext.request.contextPath}/user/question/questionList.do?search_keyword=${search_keyword}&search_keycode=${search_keycode}&currentPage=${currentPage}';
	    });
