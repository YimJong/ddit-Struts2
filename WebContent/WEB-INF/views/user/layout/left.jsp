...
<nav id="sidebar" role="navigation" data-step="2"
	...
	<div class="sidebar-collapse menu-scroll">
		<ul id="side-menu" class="nav">
			...
			<li class="leftmenu board1 active">
			...
			<li class="leftmenu board3">
				<a href="${pageContext.request.contextPath }/user/referenceRoom/referenceRoomList.do">
					<i class="fa fa-send-o fa-fw"><div class="icon-bg bg-green"></div></i>
					<span class="menu-title">자료실</span>
				</a>
			</li>
			<li class="leftmenu board4">
				<a href="${pageContext.request.contextPath }/user/qna/qnaboardList.do">
					<i class="fa fa-edit fa-fw"><div class="icon-bg bg-violet"></div></i>
					<span class="menu-title">Q&A게시판</span>
				</a>
			</li>
			<li class="leftmenu board5">
				<a href="${pageContext.request.contextPath }/user/question/questionList.do">
					<i class="fa fa-th-list fa-fw"><div class="icon-bg bg-blue"></div></i>
					<span class="menu-title">자주하는질문</span>
				</a>
			</li>
			<!-- <li class="leftmenu board6">
				<a href="#">
					<i class="fa fa-database fa-fw"><div class="icon-bg bg-red"></div></i>
					<span class="menu-title">정보마당</span>
				</a>
			</li>  -->
			<li class="leftmenu board7">
				<a href="${pageContext.request.contextPath }/user/sumnail/sumnailList.do">
					<i class="fa fa-database fa-fw"><div class="icon-bg bg-red"></div></i>
